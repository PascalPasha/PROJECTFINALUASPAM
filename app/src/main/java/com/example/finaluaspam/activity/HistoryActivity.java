package com.example.finaluaspam.activity;
...
import com.example.finaluaspam.R;
import com.example.finaluaspam.model.HistoryModel;
import com.example.finaluaspam.adapter.HistoryAdapter;
import com.example.finaluaspam.database.DatabaseHelper;
import com.example.finaluaspam.session.SessionManager;
...
public class HistoryActivity extends AppCompatActivity {
    ...
    public void refreshList() {
        ...
        for (int i = 0; i < cursor.getCount(); i++) {
            ...
            riwayat = "Telah berhasil melakukan booking tiket kereta untuk melakukan perjalanan dari " + asal + " menuju " + tujuan + " pada tanggal " + tanggal + ". " +
